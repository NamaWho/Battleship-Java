...
public class PlayerGridSetter implements Runnable {
    ...
    private void positionShips() {
        ...
        while (true) {
            ...
            } catch (Exception e) { //the only Exception that can be caught is thrown by player.receive() (it uses input.nextline(); that throws an exception if the socket is closed)
